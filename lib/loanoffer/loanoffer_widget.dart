...
import '../loan_cnfirmation/loan_cnfirmation_widget.dart';
...
class LoanofferWidget extends StatefulWidget {
  LoanofferWidget({Key key}) : super(key: key);

  @override
  _LoanofferWidgetState createState() => _LoanofferWidgetState();
}
